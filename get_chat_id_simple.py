#!/usr/bin/env python3
"""
Get your Telegram Chat ID for algo_ssr_bot (Non-interactive version)
"""
...
def get_chat_id():
    ...
    print("⏳ Waiting 5 seconds for you to send a message...")
    time.sleep(5)
        ...
        if data.get('ok') and data.get('result'):
            ...
            if updates:
                ...
                if 'message' in latest and 'chat' in latest['message']:
                    ...
                    print("💡 Please send a message to @algo_ssr_bot and run this script again")
            else:
