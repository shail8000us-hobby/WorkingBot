...
export const configTooltips = {
  leverage: {
    label: 'Leverage',
    description: 'The leverage multiplier for your trades. Higher leverage means higher risk and potential returns.',
    example: '10x means you can control $1000 worth of crypto with $100'
  },
  
  gridLevels: {
    label: 'Grid Levels',
    description: 'Number of price levels in the grid. More levels mean more granularity but smaller position sizes.',
    example: '20 levels between $30,000 and $35,000'
  },
  
  gridSpacing: {
    label: 'Grid Spacing',
    description: 'Percentage distance between grid levels. Affects how frequently trades are triggered.',
  ...
  stopLoss: {
    label: 'Stop Loss',
    description: 'Maximum loss percentage before bot automatically closes positions to protect capital.',
  ...
  demoMode: {
    label: 'Demo Mode',
    description: 'When enabled, uses testnet/paper trading without risking real money. Perfect for testing strategies.',
    example: 'Always test in demo mode first!'
  },
  
  capitalProtection: {
    label: 'Capital Protection',
    description: 'Automatically monitors and protects your capital from excessive losses with multiple safety mechanisms.',
    example: 'Stops trading if daily loss exceeds threshold'
  },
  
  liquidationProtection: {
    label: 'Liquidation Protection',
    description: 'Monitors liquidation risk and automatically reduces positions when risk is too high.',
