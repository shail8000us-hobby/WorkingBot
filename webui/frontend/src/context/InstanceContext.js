...
export const InstanceProvider = ({ children }) => {
  ...
  const changeInstance = useCallback((instanceName, options = {}) => {
  ...
  const getCachedData = useCallback((instanceName) => {
  ...
  const fetchWithInstance = useCallback(async (url, options = {}) => {
