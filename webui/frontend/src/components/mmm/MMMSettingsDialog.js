...
const PARAM_TOOLTIPS = {
  ...
  whipsaw_engine: 'Whipsaw engine selector: LEGACY, SMART, or OFF. This is the single source of truth — setting SMART here activates the Smart engine immediately on the next heartbeat. Hot-reloadable. Emergency rollback: set env MMM_WHIPSAW_FORCE_LEGACY=1.',
  ...
  whipsaw_smart_enabled: '[DEPRECATED] This setting no longer affects engine selection. Use whipsaw_engine to control the active engine.',
