  ...
  return (
    <Box>
      ...
      <Box sx={{ mb: 2, display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <Chip label={`${filteredChain.length} strikes`} size="small" variant="outlined" />
      ...
      <Box sx={{ mb: 1, px: 1 }}>
        <Typography variant="caption" color="text.secondary">
          💡 Click <strong>B</strong> to Buy or <strong>S</strong> to Sell. You can also click on
          Bid/Ask prices directly.
        </Typography>
      </Box>
      ...
      <TableContainer sx={{ maxHeight: 520, overflowX: 'auto' }}>
        <Table size="small" stickyHeader>
          <TableHead>
            ...
            <TableRow>
              <TableCell sx={{ borderRight: '1px solid #333', minWidth: 55, fontSize: '0.7rem' }}>
                Trade
              </TableCell>
              ...
              <TableCell
                sx={{ borderRight: '1px solid #333', color: 'success.main', fontSize: '0.7rem' }}
              >
                Bid
              </TableCell>
              <TableCell
                sx={{ borderRight: '1px solid #333', color: 'error.main', fontSize: '0.7rem' }}
              >
                Ask
              </TableCell>
              ...
              <TableCell
                align="center"
                sx={{ borderRight: '2px solid #666', fontWeight: 'bold', fontSize: '0.75rem' }}
              >
                Strike
              </TableCell>
              ...
              return (
                <TableRow
                  ...
                  sx={{
                    ...
                    bgcolor: isATM
                      ? 'rgba(255, 193, 7, 0.2)'
                      : isSuggested && strategyMode && !builderMode
                  ...
                  >
                    ...
                    {hasCall && (
                      <TradeButtons
                        ...
                        disabled={
                          !onTrade || (!builderMode && (isCallSelectedBuy || isCallSelectedSell))
                        }
                  ...
                  >
                    ...
                    {hasPut && (
                      <TradeButtons
                        ...
                        disabled={
                          !onTrade || (!builderMode && (isPutSelectedBuy || isPutSelectedSell))
                        }
