  ...
  const handleExecute = useCallback(async () => {
    ...
    try {
      ...
      if (!executeResponse.ok || !executeResult.success) {
        ...
        if (executeResult.errors && Array.isArray(executeResult.errors) && executeResult.errors.length > 0) {
          ...
          <Grid item xs={12} md={6}>
            ...
            <Paper variant="outlined" sx={{ p: 2, mb: 2 }}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  <Typography variant="caption" color="text.secondary">Net Cost/Credit</Typography>
                  <Typography 
                    variant="h6" 
                    fontWeight="bold"
            ...
            <Paper variant="outlined" sx={{ p: 2 }}>
              ...
              <Alert severity="info" sx={{ mt: 2 }} icon="💡">
                <Typography variant="caption">
                  ...
                  <br />
                  <strong>Sequential:</strong> Legs placed one by one (may have slippage between legs).
                </Typography>
              </Alert>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
              ...
              {payoffData ? (
                ...
                <Box sx={{ 
                  ...
                  <Typography color="text.secondary">
                    Select legs to see payoff diagram
                  </Typography>
                </Box>
              )}
            </Paper>
            ...
            <Alert severity="warning" sx={{ mt: 2 }} icon={<WarningIcon />}>
              <Typography variant="caption">
                ...
                Ensure you understand the risks before executing this strategy.
