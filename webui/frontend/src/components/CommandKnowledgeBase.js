  ...
  const commandCategories = [
    ...
    },
    {
      ...
      commands: [
        {
          name: 'Start WebUI',
          description: 'Start WebUI production backend via LaunchAgent',
        ...
        {
          name: 'Stop WebUI',
          description: 'Stop WebUI production backend',
          command: 'launchctl stop com.gridbot.production.webui',
          icon: <StopIcon />,
          tags: ['webui', 'backend', 'stop'],
        },
        {
          name: 'Restart WebUI',
          description: 'Restart WebUI production LaunchAgent',
          command: 'launchctl stop com.gridbot.production.webui; sleep 3; launchctl start com.gridbot.production.webui',
          icon: <RefreshIcon />,
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          command: 'launchctl start com.gridbot.production.guardian',
          icon: <PlayArrowIcon />,
          tags: ['guardian', 'start', 'monitoring'],
        },
        {
          name: 'Stop Guardian',
          description: 'Stop Guardian monitoring',
          command: 'launchctl stop com.gridbot.production.guardian',
          icon: <StopIcon />,
          tags: ['guardian', 'stop'],
        },
        {
          ...
          command: 'launchctl stop com.gridbot.production.guardian; sleep 2; launchctl start com.gridbot.production.guardian',
          icon: <RefreshIcon />,
