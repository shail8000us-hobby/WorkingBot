...
# Legacy imports removed - no longer needed after YAML migration
...
class StateStore:
    ...
    def locked_read(self) -> Dict[str, Any]:
        ...
        if not self._validate(data):
            return self._clone_default()
        # upgrade_mapping(data, record=False)  # Legacy - removed after YAML migration
        return data
    ...
    def save(self, data: Dict[str, Any]) -> None:
        try:
            # upgrade_mapping(data, record=False)  # Legacy - removed after YAML migration
            # strip_legacy_keys(data)  # Legacy - removed after YAML migration
